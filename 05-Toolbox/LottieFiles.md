---
title: "LottieFiles — preview, host, test, share"
type: document
status: published
visibility: public
owner: Reid
created: 2026-08-19
updated: 2026-08-19
tags: [toolbox, lottie, lottiefiles, unit-2]
related: []
verify: false
---

# LottieFiles — the Lottie ecosystem hub
...
- **`.json`** — classic Lottie: the animation data, human-readable.
- **`.lottie` (dotLottie)** — the production wrapper: zipped, smaller, can bundle multiple animations and assets.

## Where it appears

Week 6 onward — every Lottie deliverable in the course passes through it.

**Tutorials:** see [[Learning-Resources]] tagged `week-06` / `week-07`.
